    ...
    <div className="min-h-screen bg-[#f4f4f4]">
      ...
      <header className="bg-white border-b-2 border-[#d4d4d4] sticky top-0 z-30">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold text-[#647687] uppercase tracking-widest">Mejores tiempos por nivel</p>
          </div>
          <div className="w-10" />
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 space-y-4">
        ...
        {!loading && orderedLevels.map((levelId) => {
          ...
          const records = rankings[levelId] ?? [];
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-bold text-[#333333] truncate">{rec.nombre}</p>
                          </div>

                          {/* Score */}
                          <div className="text-right shrink-0">
                            <p className="font-black text-[#333333]">{rec.puntuacion.toLocaleString()} pts</p>
                            <p className="text-xs text-[#647687] flex items-center gap-1 justify-end">
                              <Clock size={11} /> {formatTime(rec.tiempo_total)}
                            </p>
                          </div>
